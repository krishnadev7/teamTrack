...
const ModalNewProject = ({ isOpen, onClose }: Props) => {
    ...
    const inputStyles = "w-full rounded border border-gray border-gray-300 p-2 shadow-sm dark:border-dark-tertiary dark:bg-dark-tertiary dark:text-white dark:focus:outline-none"
        ...
        <Modal isOpen={isOpen} onClose={onClose} name="Create New Project">
            ...
            >
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-2">
                    <div className='flex flex-col dark:text-white m-2 text-sm'>
