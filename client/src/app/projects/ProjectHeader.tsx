...
const ProjectHeader = ({ activeTab, setActiveTab }: Props) => {
    const [isProjectNewModalOpen, setIsProjectNewModalOpen] = useState<boolean>(false);
    return (
        <div className="px-4 xl:px-6">
            ...
            <div className="pb-6 pt-6 lg:pb-4 lg:pt-8">
                <Header name="Product Design Developement"
                    buttonComponent={
                        <button className="flex items-center rounded-md bg-blue-primary px-3 py-2 text-white hover:text-blue-600"
